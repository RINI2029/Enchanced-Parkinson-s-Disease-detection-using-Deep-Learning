...
class HybridClassifierApp(tk.Tk):
    ...
    def classify_image(self):
        ...
        print(f"Predicted Image Class: {self.image_prediction}")
    ...
    def browse_eeg_data(self):
        ...
        if filepath:
            ...
            try:
                ...
                print(f"Predicted EEG Classes: {predicted_classes}")
    ...
    def make_final_diagnosis(self):
        ...
        print(f"Image Prediction: {self.image_prediction}, EEG Prediction: {self.eeg_prediction}")
        final_diagnosis_text = "Diagnosis cannot be determined. Data conflict."
        
        image_prediction_lower = self.image_prediction.lower().strip()
        
        # Corrected logic to check for 'parkinson' or 'parkinsons'
        if "parkinson" in image_prediction_lower: 
            print(f"EEG Prediction Value: {self.eeg_prediction}")
        ...
        elif "healthy" in image_prediction_lower:
            ...
            if self.eeg_prediction in [0, 1]:
                ...
                final_diagnosis_text = "Final Diagnosis: Mild Condition (Image is healthy, but EEG suggests a mild issue)"
            ...
            final_diagnosis_text = f"Diagnosis cannot be determined. Image classified as '{self.image_prediction}' which has no specific diagnosis rule."
        
        print(f"Final Diagnosis: {final_diagnosis_text}")
